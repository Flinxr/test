...
function LoginConfirm(){
    ...
    if(username == 'admin'){
        ...
        window.location.href=window.location.origin + '/source/admin.html'
    }

    if(username == 'user'){
        localStorage.setItem('token','eusfhuufshudifuhuywsufhdf')
        window.location.href=window.location.origin + '/source/userCart.html'
    }else{
    }
}
...
function onlineclasshref(){
    window.location.href=window.location.origin + '/source/onlineClass.html'
}

function inpersonclasshref(){
    window.location.href=window.location.origin + '/source/inPersonClass.html'
}
